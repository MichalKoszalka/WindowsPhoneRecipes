...
namespace Pyszności
{
    ...
    public sealed partial class BasicPage1 : Page
    {
        ...
        private void AddFavouriteAppBarButton_Click(object sender, RoutedEventArgs e)
        {
            var recipe = (Recipe)this.defaultViewModel["Recipe"];
            recipe.Favourite = true;
            SampleDataSource.AddToFavouritesAsync(recipe);
            AddFavouriteAppBarButton.IsEnabled = false;
            RemoveFavouriteAppBarButton.IsEnabled = true;
        }

        private void RemoveFavouriteAppBarButton_Click(object sender, RoutedEventArgs e)
        {
            var recipe = (Recipe)this.defaultViewModel["Recipe"];
            recipe.Favourite = false;
            SampleDataSource.RemoveFromFavouritesAsync(recipe);
            AddFavouriteAppBarButton.IsEnabled = true;
            RemoveFavouriteAppBarButton.IsEnabled = false;
        }
    }
